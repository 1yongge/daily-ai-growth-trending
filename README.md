...
- **Created**: `2026-05-12`
- **Updated**: `2026-05-27`
- **Topics**: 人工智能 / AI 智能体 / Claude / coding-agents / constitution / cursor
- **项目简介**: 这是一个智能体项目，关注该方向的工程实践。
- **适用场景**: 适合做 AI 智能体、自动执行和多 Agent 协作
...
- **Created**: `2026-05-18`
- **Updated**: `2026-05-28`
- **Topics**: 人工智能 / Claude Code / claude-skills / daily-digest / 大语言模型 / news-aggregator
- **项目简介**: 这是一个AI 项目，关注该方向的工程实践。
- **适用场景**: 适合做 AI 编程、项目脚手架和开发工作台
...
- **Created**: `2026-05-02`
- **Updated**: `2026-05-28`
- **Topics**: 人工智能 / alumni / docker / education / element-plus / express
